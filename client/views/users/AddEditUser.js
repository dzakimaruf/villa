...
export default function AddEditUser(props) {
    ...
    useEffect(() => {
        if (props.user.actionType === 'Edit') {
            ...
            apiRegion.findOne(props.user.user_id).then(data => {
                ...
                setValues({ ...values, user_id: data.user_id, user_name: data.user_name })
            })
        } else {
            setValues({ ...values, user_id: undefined, user_name: "" })
        }
    ...
    const onSubmit = () => {
        ...
        if (props.user.actionType === 'Add') {
            ...
            apiRegion.update(values).then((data) => {
                if (data.error) {
